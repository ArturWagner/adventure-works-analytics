...
-- Extract and transform FactInternetSales from AdventureWorks2022
-- Target: adventureworks.fact_internet_sales (BigQuery)
...
FROM AdventureWorks2022.dbo.FactInternetSales
